...
class PlaneTest {
    ...
    public void testFindIntersections() {
        ...
        assertNull(plane1.findIntersections(new Ray(new Point(0,0,2), new Vector(0,1,1))), "Ray's line after plane");
        ...
        assertNull(plane2.findIntersections(new Ray(new Point(0.5, 0.25, 0.25), new Vector(-0.5, 0.2, 0.3))),
        ...
        assertNull(plane2.findIntersections(new Ray(new Point(0.6, 0.25, 0.25), new Vector(-0.5, 0.2, 0.3))),
        ...
        final var result2 = plane2.findIntersections(new Ray(new Point(0.6, 0.25, 0.25), new Vector(-1, -1, -1)));
        ...
        assertNull(plane2.findIntersections(new Ray(new Point(0.5, 0.25, 0.25), new Vector(-1, -1, -1))),
        ...
        assertNull(plane2.findIntersections(new Ray(new Point(0.4, 0.25, 0.25), new Vector(-1, -1, -1))),
